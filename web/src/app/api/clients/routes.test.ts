...
describe("console client route contracts", () => {
  ...
  it("returns a readable conflict when the stage routine refuses a skipped or backwards manual move", async () => {
    ...
    assert.deepEqual(await response.json(), {
      error: {
        ...
        message: "A client can only move forward one stage at a time.",
      },
    });
  });
