-- C6: operators may correct a stage by one step, but cannot skip the tracker.
-- The public routine is a tenant-wall wrapper; keep system transitions on the
-- same private implementation and constrain only the manual branch below.
